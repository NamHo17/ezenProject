		   ...
		   <div class="box" >
		    	...
		    	<div class="box-content">
				    <div class="group_p">
				  	...
				  	<div class="group_p">
				   	...
				   	<a href="/setMainAddress"><button type="button" class="btn btn-lg address-btn text-white rounded-0" >주소 편집</button></a>      
		    	</div>
		 	</div>
			...
			<div class="box" >
		    	...
		    	<div class="box-content address-content">
				   ...
				   <a href="updateSubAddress?address_index=${add.address_index }"><button type="button" class="btn btn-lg text-white address-btn rounded-0" >주소 편집</button></a>
	               <a href="deleteSubAddress?address_index=${add.address_index }"><button type="button" class="btn btn-lg address-btn address-btn-w rounded-0">주소 삭제</button></a>
		    	</div>
		 	</div>
			</c:forEach>
			<% if ( 3 > result ){ %>
